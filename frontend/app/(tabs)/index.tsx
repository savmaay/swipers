...
function Cloud({ text, x, y, width, delay, float, rotation }: any) {
  ...
  return (
    <Animated.View style={{ position: 'absolute', left: x, top: y, width, height, opacity: fadeAnim, transform: [{ translateY: floatAnim }], alignItems: 'center', justifyContent: 'center', zIndex: 10 }}>
      <Image source={require('../../assets/images/cloud.png')} style={{ width, height, resizeMode: 'contain', transform: [{ rotate: rotation }] }} />
...
export default function Index() {
  ...
  if (needsOnboarding) return <Redirect href="/onboarding/interests" />;

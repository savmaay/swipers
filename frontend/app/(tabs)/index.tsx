...
function Cloud({
  ...
  return (
    ...
    >
      ...
      />
      {/* Text centered over cloud, doesn't rotate */}
...
// Tab Bar 
function TabBar({ activeTab = 0 }: { activeTab?: number }) {
  const tabs = [
  ...
  return (
    <View style={styles.tabBar}>
      {tabs.map((tab, index) => (
        <TouchableOpacity key={index} style={styles.tabItem} activeOpacity={0.7}>
...
export default function DashboardScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Cloud 1 — top left */}
      <Cloud
        text={`${stats.newEvents} new events!`}
        x={CLOUD1_X}
        y={CLOUD1_Y}
        width={CLOUD1_WIDTH}
        delay={100}
      ...
      {/* Cloud 2 — middle right */}
      <Cloud
        text={`${stats.newMessages} new messages!`}
        x={CLOUD2_X}
        y={CLOUD2_Y}
        width={CLOUD2_WIDTH}
        delay={300}
      ...
      {/* Cloud 3 — lower left */}
      <Cloud
        text={`${stats.todayEvents} events today!`}
        x={CLOUD3_X}
        y={CLOUD3_Y}
        width={CLOUD3_WIDTH}
        delay={200}
